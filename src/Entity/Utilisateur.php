...
class Utilisateur
{
    ...
    private ?string $nom_d_utilisateur = null;
     ...
     */
    #[ORM\OneToMany(targetEntity: Commentaire::class, mappedBy: 'utilisateur_id')]
    ...
    public function setNomDUtilisateur(string $nom_d_utilisateur): static
    {
